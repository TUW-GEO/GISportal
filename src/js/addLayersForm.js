...
gisportal.addLayersForm.displayForm = function(total_pages, current_page, form_div){
   ...
   try{
      ...
      $.ajax({
         url: gisportal.ProxyHost + encodeURIComponent(l.wmsURL + 'item=minmax&layers=' + l.urlName + time + '&bbox=' + bbox + '&srs=EPSG:4326&width=50&height=50&request=GetMetadata&VERSION=1.1.1'),
         dataType: 'json',
         success: function( data ) {
